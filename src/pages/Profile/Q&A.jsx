...
import {useAnswerQuestionMutation} from "../../redux/apis/profile.api";
				...
				answers: [
					{
						...
						prefer_answer: desiredAnswers[1],
						importance: importance[1],
					},
					{
						question_id: 2,
						user_answer: answers[2],
						prefer_answer: desiredAnswers[2],
						importance: importance[2],
					},
					{
						question_id: 3,
						user_answer: answers[3],
						prefer_answer: desiredAnswers[3],
						importance: importance[3],
					},
					{
						question_id: 4,
						user_answer: answers[4],
						prefer_answer: desiredAnswers[4],
						importance: importance[4],
					},
					{
						question_id: 5,
						user_answer: answers[5],
						prefer_answer: desiredAnswers[5],
